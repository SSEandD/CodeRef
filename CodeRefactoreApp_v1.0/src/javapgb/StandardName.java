...
public class StandardName {
    public static String[] Modifier = {"public", "protected", "private", "abstract", "static", "final", "transient",
                        ...
                        if (temp.equals("package")) {
                            ...
                            try {
                                ...
                                if (!oldName.equals(newName)) {
                                    ...
                                    arrayListTemp1 =
                                        (ArrayList)arrayList.get(Integer.parseInt(String.valueOf(classNameAddNotes
                                            .get(0))));
                                    arrayListTemp1.add(Integer.parseInt(String.valueOf(classNameAddNotes.get(1))) + 1,
...
//                                        "/***** Suggest:Method's name must be hump structure  *****/\r\n");
                            ...
                            if (hasNew(arrayListNew)) {
                                ...
                                try {
                                    if ((!isClassName(arrayListClass, oldName)) && needChange
                                        && (arrayListNew.size() > 1)) {
                                        if (oldName.length() == 1) {
